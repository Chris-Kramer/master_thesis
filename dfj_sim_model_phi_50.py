...
run_sim_model(first_day,
              ...
              phi = phi,
              epsilon = 12,
              output_txt= "results/phi_50_new_model/phi_50.txt",
              output_csv = "results/phi_50_new_model/phi_50.csv",
              output_dict= "results/phi_50_new_model/phi_50.pkl")
...
# Get Data
results_df = pd.read_csv("results/phi_50_new_model/phi_50.csv")
...
fig.write_html("results/phi_50_new_model/phi_50.html")