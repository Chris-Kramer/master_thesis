...
run_sim_model(first_day,
              ...
              phi = phi,
              epsilon = 5,
              output_txt= "results/phi_15_new_model/phi_15.txt",
              output_csv = "results/phi_15_new_model/phi_15.csv",
              output_dict= "results/phi_15_new_model/phi_15.pkl")
...
# Get Data
results_df = pd.read_csv("results/phi_15_new_model/phi_15.csv")
...
fig.write_html("results/phi_15_new_model/phi_15.html")